<if:create>
	...
	There's no rule saying you can't use a poll question from a previous camp but it's nice if most of the polls are different. Be careful of your spelling: once your poll has been created you won't be able to change the question or responses without asking a tech leader.<br />
	Poll questions and responses are limited to 50 characters, although in practice you should keep the responses a lot shorter. There is no limit to the number of responses that a poll can have, but try not to be ridiculous.<br /><br />
	<if:camper>
	<strong>A leader will have to approve your poll before people can vote on it.</strong> This will usually be done within a few minutes.<br /><br />
	</if:camper>
